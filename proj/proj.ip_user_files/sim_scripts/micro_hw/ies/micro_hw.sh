...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../bd/micro_hw/ipshared/user.org/micro_agg_v1_0/hdl" +incdir+"$ref_dir/../../../../proj.srcs/sources_1/bd/micro_hw/ipshared/user.org/micro_agg_v1_0/hdl" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.micro_hw xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.micro_hw -input simulate.do
}
# Script usage
usage()
{
