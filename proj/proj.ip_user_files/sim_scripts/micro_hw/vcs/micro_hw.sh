...
reset_run()
{
  files_to_remove=(ucli.key micro_hw_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc micro_hw_simv.daidir)
...
compile()
{
  ...
  vlogan -work xil_defaultlib $opts_ver +v2k +incdir+"$ref_dir/../../../bd/micro_hw/ipshared/user.org/micro_agg_v1_0/hdl" +incdir+"$ref_dir/../../../../proj.srcs/sources_1/bd/micro_hw/ipshared/user.org/micro_agg_v1_0/hdl" \
    "$ref_dir/./../../../bd/micro_hw/ipshared/user.org/micro_agg_v1_0/hdl/MICRO_AGG_v1_0_S_AXIS.v" \
    "$ref_dir/./../../../bd/micro_hw/ipshared/user.org/micro_agg_v1_0/hdl/MICRO_AGG_v1_0_M_AXIS.v" \
    "$ref_dir/./../../../bd/micro_hw/ipshared/user.org/micro_agg_v1_0/hdl/four.v" \
    "$ref_dir/./../../../bd/micro_hw/ipshared/user.org/micro_agg_v1_0/hdl/eight.v" \
    "$ref_dir/./../../../bd/micro_hw/ipshared/user.org/micro_agg_v1_0/hdl/thtwo.v" \
    "$ref_dir/./../../../bd/micro_hw/ipshared/user.org/micro_agg_v1_0/hdl/steen.v" \
    "$ref_dir/./../../../bd/micro_hw/ipshared/user.org/micro_agg_v1_0/hdl/sum_reg.v" \
    "$ref_dir/./../../../bd/micro_hw/ipshared/user.org/micro_agg_v1_0/hdl/MICRO_AGG_v1_0.v" \
    "$ref_dir/./../../../bd/micro_hw/ip/micro_hw_MICRO_AGG_0_0/sim/micro_hw_MICRO_AGG_0_0.v" \
    "$ref_dir/./../../../bd/micro_hw/hdl/micro_hw.v" \
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.micro_hw xil_defaultlib.glbl -o micro_hw_simv
}
...
simulate()
{
  ...
  ./micro_hw_simv $opts -do simulate.do
}
# Script usage
usage()
{
