...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb micro_hw.wdb xsim.dir)
...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto 42dfba1278c34254992dfb1d5586c7fb -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot micro_hw xil_defaultlib.micro_hw xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim micro_hw -key {Behavioral:sim_1:Functional:micro_hw} -tclbatch cmd.tcl -log simulate.log
}
# Script usage
usage()
{
