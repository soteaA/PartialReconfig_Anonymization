...
HD_PWD=/home/einsamer-wolf/Vivado/proj/anon_pr_1/proj/proj.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log anon_hw_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source anon_hw_wrapper.tcl -notrace
