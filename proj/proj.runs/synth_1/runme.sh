...
HD_PWD=/home/einsamer-wolf/Vivado/proj/anon_pr_1/proj/proj.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log anon_hw_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source anon_hw_wrapper.tcl
